...
print("test",recherche_dichotomique("aaa", L))
...
def plus_long_mc(P, M):
    ...
    motifs_communs = []
    for indice in maxindice:
        i, j = indice
        motif = P[i - maxlen + 1 : i + 1]
        motifs_communs.append(motif)

    motifmax = [motif for motif in motifs_communs if len(motif) == maxlen]
    return motifmax
